...
if (true) {
    ...
    WebUI.setText(findTestObject('Page_CuraAppointment/txt_VisitDate'), '31/12/2024')
...
WebUI.comment('Berhasil membuat appointment, menampilkan data appointment yang sudah diinput sebelumnya')
...
if (true) {
    ...
    WebUI.verifyMatch('None', WebUI.getText(findTestObject('Page_AppointmentConfirmation/lbl_Program')), false)

    WebUI.verifyMatch('31/12/2024', WebUI.getText(findTestObject('Page_AppointmentConfirmation/lbl_VisitDate')), false)

    WebUI.verifyMatch('Semoga jadwal tidak bentrok', WebUI.getText(findTestObject('Page_AppointmentConfirmation/lbl_Comment')), 
        false)
}
